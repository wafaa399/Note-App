...
function refreshList() {
  ...
  renderNotesList({ pinned, unpinned, ...selectHandlers });

  // نسخة المنيو بتاعة الموبايل (PINNED/OTHER)
  renderFlatList(
    document.getElementById("mobilePinnedList"),
    pinned,
    selectHandlers,
  );
  renderFlatList(
    document.getElementById("mobileOtherList"),
    unpinned,
    selectHandlers,
  );

  // نتايج البحث في overlay الموبايل
  if (document.getElementById("mobileSearchResults")) {
    renderFlatList(
