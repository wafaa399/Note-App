  ...
  container.innerHTML = `
    ...
    <h2 class="text-[1.63rem] leading-8 font-semibold text-[#303030] mb-6">Add Note</h2>
      ...
      <div class="flex gap-3">
        <button id="addNoteBtn" class="[9rem] h-[2.8125rem] bg-[#EC7160] text-white px-4 py-2 rounded hover:bg-[#e05f4d]">Add Note</button>
        <button id="addPinnedBtn" class="bg-[#EC7160] text-white  px-4 py-2 rounded hover:bg-[#e05f4d]">Add pinned note</button>
      </div>
    </div>
  `;
