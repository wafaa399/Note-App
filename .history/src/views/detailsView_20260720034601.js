...
export function renderNoteDetail(note) {
  ...
  container.innerHTML = `
   <div class="w-full max-w-[37.5rem] mx-auto">
...
export function renderAddNoteForm({ onSubmit }) {
  ...
  container.innerHTML = `
    ...
    <div class="w-full max-w-[37.5rem] space-y-4 mx-auto">
    <h2 class="text-[1.63rem] leading-8 font-semibold text-[#303030] mb-6">Add Note</h2>
      <div class="w-full max-w-[31.25rem] h-[4.4375rem]">
        <label class="block text-gray-500 mb-1">Title*</label>
        <input id="noteTitle" type="text" class="w-full h-[2.8125rem] border border-gray-200 rounded px-3 py-2 outline-none focus:ring-1 focus:ring-red-400" />
      </div>
      <div class="w-full max-w-[31.25rem] h-[4.4375rem]">
        <label class="block text-gray-500 mb-1">Author*</label>
        <input id="noteAuthor" type="text" class="w-full h-[2.8125rem] border border-gray-200 rounded px-3 py-2 outline-none focus:ring-1 focus:ring-red-400" />
      </div>
      <div class="w-full max-w-[31.25rem]">
        <label class="block text-gray-500 mb-1">Your Note*</label>
        <textarea id="noteContent" rows="6" class="w-full h-[12rem] border border-gray-200 rounded px-3 py-2 outline-none focus:ring-1 focus:ring-red-400"></textarea>
      </div>
