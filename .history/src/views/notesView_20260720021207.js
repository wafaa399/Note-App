...
function noteItemHTML(note) {
  return `
    <div class="w-[16.625rem] h-[6.625rem] note-item cursor-pointer px-2 py-2 rounded hover:bg-gray-50" data-id="${note.id}">
      ...
      <p class="w-[16.5625rem] h-[2.5rem] text-[#898989]  text-[.82rem] font-medium mt-1">${truncate(note.content, 70)}</p>
      <div class="flex justify-between items-center mt-1">
        <span class="text-[#898989] text-[.82rem] leading-[] font-medium mt-2">${formatDate(note.date)}</span>
